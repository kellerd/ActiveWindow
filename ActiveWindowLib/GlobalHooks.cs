...
namespace TransparencyMenu
{
    public class GlobalHooks
    {
        ...
        public delegate void ActivateShellWindowEventHandler(object sender, EventArgs e);
        public delegate void HookReplacedEventHandler(object sender, EventArgs e);
        public delegate void TaskmanEventHandler(object sender, EventArgs e);
        public delegate void BasicHookEventHandler(object sender, BasicHookEventArgs e); //IntPtr Handle1, IntPtr Handle2
        public delegate void WndProcEventHandler(object sender, WndProcEventArgs e); //IntPtr Handle, IntPtr Message, IntPtr wParam, IntPtr lParam
            ...
            public override void ProcessWindowMessage(ref System.Windows.Forms.Message m)
            {
                if (m.Msg == _MsgID_CBT_HookReplaced)
                {
                    if (HookReplaced != null)
                        HookReplaced(this, new EventArgs());
                }
                else if (m.Msg == _MsgID_CBT_Activate)
                {
                    if (Activate != null)
                        Activate(this, new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_CBT_CreateWnd)
                {
                    if (CreateWindow != null)
                        CreateWindow(this, new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_CBT_DestroyWnd)
                {
                    if (DestroyWindow != null)
                        DestroyWindow(this, new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_CBT_MinMax)
                {
                    if (MinMax != null)
                        MinMax(this, new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_CBT_MoveSize)
                {
                    if (MoveSize != null)
                        MoveSize(this, new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_CBT_SetFocus)
                {
                    if (SetFocus != null)
                        SetFocus(this, new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_CBT_SysCommand)
                {
                    if (SysCommand != null)
                        SysCommand(this, new SysCommandEventArgs() { SysCommand = m.WParam.ToInt32(), lParam = m.LParam.ToInt32() });
                }
            }
        }
        ...
        public class ShellHook : Hook
        {
            ...
            public override void ProcessWindowMessage(ref System.Windows.Forms.Message m)
            {
                ...
                {
                    if (GetMinRect != null)
                        GetMinRect(this , new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_Shell_Language)
                {
                    if (Language != null)
                        Language(this , new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_Shell_Redraw)
                {
                    if (Redraw != null)
                        Redraw(this , new WindowEventArgs { Handle = m.WParam });
                }
                ...
                else if (m.Msg == _MsgID_Shell_WindowActivated)
                {
                    if (WindowActivated != null)
                        WindowActivated(this , new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_Shell_WindowCreated)
                {
                    if (WindowCreated != null)
                        WindowCreated(this , new WindowEventArgs { Handle = m.WParam });
                }
                else if (m.Msg == _MsgID_Shell_WindowDestroyed)
                {
                    if (WindowDestroyed != null)
                        WindowDestroyed(this , new WindowEventArgs { Handle = m.WParam });
                }
            }
        }
            ...
            public override void ProcessWindowMessage(ref System.Windows.Forms.Message m)
            {
                if (m.Msg == _MsgID_Keyboard)
                {
                    if (KeyboardEvent != null)
                        KeyboardEvent(this, new BasicHookEventArgs() { Handle1 = m.WParam, Handle2 = m.LParam });
                }
        ...
        public class MouseHook : Hook
        {
            ...
            public override void ProcessWindowMessage(ref System.Windows.Forms.Message m)
            {
                ...
                {
                    if (MouseEvent != null)
                        MouseEvent(this, new BasicHookEventArgs() { Handle1 = m.WParam, Handle2 = m.LParam });
                }
            ...
            public override void ProcessWindowMessage(ref System.Windows.Forms.Message m)
            {
                if (m.Msg == _MsgID_KeyboardLL)
                {
                    if (KeyboardLLEvent != null)
                        KeyboardLLEvent(this, new BasicHookEventArgs { Handle1 = m.WParam, Handle2 = m.LParam });
                }
            ...
            public override void ProcessWindowMessage(ref System.Windows.Forms.Message m)
            {
                if (m.Msg == _MsgID_MouseLL)
                {
                    if (MouseLLEvent != null)
                        MouseLLEvent(this, new BasicHookEventArgs { Handle1 = m.WParam, Handle2 = m.LParam });
            ...
            public override void ProcessWindowMessage(ref System.Windows.Forms.Message m)
            {
                ...
                else if (m.Msg == _MsgID_CallWndProc_Params)
                {
                    if (CallWndProc != null && _CacheHandle != IntPtr.Zero && _CacheMessage != IntPtr.Zero)
                        CallWndProc(this, new WndProcEventArgs() { Handle = _CacheHandle, Message = _CacheMessage, wParam = m.WParam, lParam = m.LParam });
            ...
            public override void ProcessWindowMessage(ref System.Windows.Forms.Message m)
            {
                ...
                else if (m.Msg == _MsgID_GetMsg_Params)
                {
                    if (GetMsg != null && _CacheHandle != IntPtr.Zero && _CacheMessage != IntPtr.Zero)
                        GetMsg(this, new WndProcEventArgs() { Handle = _CacheHandle, Message = _CacheMessage, wParam = m.WParam, lParam = m.LParam });
                    _CacheHandle = IntPtr.Zero;
                    _CacheMessage = IntPtr.Zero;
                }
...
{
   public class BasicHookEventArgs : EventArgs
    {
